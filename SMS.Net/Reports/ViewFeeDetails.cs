...
{
    public partial class ViewFeeDetails : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM dbo.FeeDetailsInfo T1 INNER JOIN dbo.FeeInfo T2 ON T1.FeeId=T2.FeeId WHERE T1.ClassId='" + cid + "' AND T1.AcademicYearId='" + aid + "'";
            SqlCommand cmd = new SqlCommand();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rd.Load(@"E:\SMS\SMS.Net\SMS.Net\Reports\FeeDetailsCrystalReport.rpt");
        ...
        private void ViewFeeDetails_Load(object sender, EventArgs e)
        {
            BindBatch();
            BindClassComboBox();
        }
