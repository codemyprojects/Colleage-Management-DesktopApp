...
namespace SMS.Net.Reports
{
    public partial class ImageForm1 : Form
    {
        ...
        private void ImageForm1_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM dbo.ImageInfo";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rd.Load(@"E:\SMS\SMS.Net\SMS.Net\Reports\ImageCrystalReport.rpt");
